...
F.update({
    ...
    'ui.sleep_hours': ('Sono, horas por noite', 'Sleep, hours a night'),
    'ui.stress_avg': ('Stress médio', 'Average stress'),
    'ui.bb_wake': ('Body Battery ao acordar', 'Body Battery on waking'),
    'ui.body_comp': ('Peso e composição', 'Weight and composition'),
    'ui.last_n': ('últimas {n}', 'last {n}'),
    'ui.previous_n': ('{n} anteriores', 'previous {n}'),
    'ui.better': ('melhor', 'better'),
    'ui.worse': ('pior', 'worse'),
    'ui.unchanged': ('igual', 'unchanged'),
    'th.change': ('Mudança', 'Change'),
    'th.now': ('Agora', 'Now'),
    'm.bmi': ('IMC', 'BMI'),
    'm.body_fat': ('Massa gorda', 'Body fat'),
    'm.muscle_mass': ('Massa muscular', 'Muscle mass'),
